...
const MetolynLanding = () => {
  ...
  const questions = [
    ...
    {
      question: "How often do you experience low energy?",
      options: [
        "Rarely",
        "Some days",
        "Most days",
    ...
    {
      question: "Have you tried other metabolism supplements before?",
      options: [
        "Never tried any",
        "Tried 1-2 with little results",
        "Tried several with some results",
        "Tried many with no results"
      ]
    }
  ];
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-indigo-900 to-blue-900 p-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800">
              PERSONALIZED METOLYN RECOMMENDATION
            </h2>
            <p className="text-gray-600 mt-2">
              Answer 3 quick questions to get your customized plan
            </p>
            ...
            <div className="space-y-3">
              {questions[currentQuestion].options.map((option, index) => (
                <button
                  ...
                  className="w-full bg-gray-100 hover:bg-amber-100 text-gray-800 font-medium py-3 px-4 rounded-lg transition border border-gray-200 text-left"
                >
                  {option}
                </button>
              ))}
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-indigo-900 to-blue-900 p-4 relative">
        ...
        <div className={`bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full ${isLoading ? 'opacity-50' : ''}`}>
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mt-2">
              Enter your email to receive your customized Metolyn recommendation
            </p>
          </div>
    ...
    <div className="font-sans bg-gradient-to-b from-gray-50 to-white text-gray-800">
      ...
      <section className="py-12 px-6 bg-gradient-to-b from-indigo-900 to-blue-800 text-white">
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <p className="text-lg mb-8 opacity-90 leading-relaxed">
              Based on your quiz answers, we've created a personalized Metolyn plan 
              to help activate your body's natural metabolic power.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                className="bg-amber-500 hover:bg-amber-600 text-blue-900 font-bold py-3 px-6 rounded-full transition transform hover:scale-105 flex items-center cursor-pointer"
      ...
      <section id="benefits" className="py-16 px-6 bg-white">
        <div className="container mx-auto text-center">
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <h3 className="text-4xl font-bold mb-6 text-indigo-800">METOLYN</h3>
            <p className="text-xl text-gray-700 leading-relaxed">
              Based on your quiz responses, we recommend Metolyn's revolutionary
              formula customized to address your specific metabolic needs and goals.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto cursor-pointer">
            ...
            >
              ...
              <p className="text-gray-700">
                Your unique formula based on your health goals and needs.
              </p>
            </div>
            <div
              className="bg-gradient-to-b from-blue-50 to-white p-8 rounded-2xl shadow-lg border border-blue-100 transform transition hover:-translate-y-2 cursor-pointer"
            ...
            >
              ...
              <p className="text-gray-700">
                Specifically formulated to address your primary concerns.
              </p>
            </div>
            <div
              className="bg-gradient-to-b from-blue-50 to-white p-8 rounded-2xl shadow-lg border border-blue-100 transform transition hover:-translate-y-2 cursor-pointer"
            ...
            >
              ...
              <p className="text-gray-700">
                Recommended amount based on your lifestyle and goals.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-gradient-to-b from-white to-blue-50 rounded-2xl shadow-xl overflow-hidden relative transform transition hover:-translate-y-2">
              ...
              <div className="p-8 text-center">
                ...
                <ul className="space-y-3 mb-8 text-gray-700">
                  ...
                  <li className="flex items-center justify-center">
                    <div className="w-2 h-2 bg-amber-500 rounded-full mr-2"></div>
                    <span>FREE Personalized Metabolic Guide</span>
                  </li>
                </ul>
                <button
                  className="bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white font-bold py-4 px-8 rounded-full w-full transition transform hover:scale-105 cursor-pointer"
      ...
      <section className="py-16 px-6 bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto text-center">
          ...
          <button
            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white font-bold py-4 px-8 rounded-full text-xl transition transform hover:scale-105"
            onClick={() =>
              window.open(
                "https://52a327dfgx1vs9ebph3b-a5nc0.hop.clickbank.net"
              )
          ...
          >
            GET MY PERSONALIZED METOLYN PLAN NOW
          </button>
        </div>
      </section>

      {/* Footer */}
      <footer className="bg-gradient-to-r from-blue-900 to-indigo-900 text-white py-8 px-6 text-center">
        <p>© 2025 Metolyn. All rights reserved.</p>
